          ...
          <div className="mt-12 bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl space-y-1">
                <div className="font-bold text-slate-900 text-sm">Solar Alignment</div>
                <p className="text-xs text-slate-600">
                  Because a solar year is approximately 365.2422 days, your actual moment of birth shifts slightly by ~6 hours each non-leap year.
                </p>
              </div>
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl space-y-1">
                <div className="font-bold text-slate-900 text-sm">Day of Week Cycle</div>
                <p className="text-xs text-slate-600">
                  In non-leap years, your birthday advances by 1 weekday. In leap years (after Feb 28), your birthday advances by 2 weekdays.
                </p>
              </div>
            </div>
